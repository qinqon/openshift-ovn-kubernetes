...
func EnsureDHCPOptionsForVM(controllerName string, nbClient libovsdbclient.Client, watchFactory *factory.WatchFactory, pod *corev1.Pod, lsp *nbdb.LogicalSwitchPort) error {
...
func DeleteDHCPOptions(controllerName string, nbClient libovsdbclient.Client, pod *corev1.Pod, networkName string) error {
